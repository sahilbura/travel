...
export const DirectionAwareHover = ({
  ...
  // Fallback support
  const [fallbackSrc, setFallbackSrc] = useState(imageUrl);
  ...
  return (
    <motion.div
      ...
      ref={ref}
      className={cn(
        "md:h-96 w-60 h-60 bg-transparent rounded-lg overflow-hidden group/card relative",
        className
      )}
    >
        ...
        >
          ...
          >
            <Image
              ...
              height={1000}
              src={fallbackSrc}
              onError={() => setFallbackSrc("/images/placeholder.jpg")} // fallback image from /public
            />
          </motion.div>
